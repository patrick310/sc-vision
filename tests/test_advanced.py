...
class AdvancedTestSuite(unittest.TestCase):
    ...
    def test_can_detect_an_elephant(self):
        self.assertIn('African_elephant',self.lvp.predict_top_class(self.lvp.load_image('elephant.jpg')))

    def test_can_set_and_trigger_alarm(self):
        self.lvp.set_alarm_case('African_elephant')
        self.assertTrue(self.lvp.has_alarm(self.lvp.load_image('elephant.jpg')))
